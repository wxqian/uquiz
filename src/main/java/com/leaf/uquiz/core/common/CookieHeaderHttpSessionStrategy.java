 ...
 * @date 2016/10/27
 */
public class CookieHeaderHttpSessionStrategy implements HttpSessionStrategy, HttpSessionManager {
    ...
    class MultiSessionHttpServletResponse extends HttpServletResponseWrapper {
        ...
        public String encodeRedirectURL(String url) {
            ...
            return CookieHeaderHttpSessionStrategy.this.encodeURL(url, getCurrentSessionAlias(request));
        }
